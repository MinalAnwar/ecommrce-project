    ...
    <div><Navbar isNotLanding="True" />
        <div className="p-6 max-w-4xl mt-40 mx-auto">
            ...
            <p className="mb-4 text-gray-700">
                ...
                <li>Pages viewed and referring sites</li>
            ...
            <p className="mb-4 text-gray-700">
                ...
                <li>To communicate with you about your orders, including updates and notifications</li>
                <li>To improve our website and customer service</li>
                <li>To send you promotional materials, newsletters, and other marketing communications (you can opt out at any time)</li>
            ...
            <p className="mb-4 text-gray-700">
                ...
                <li><strong>Legal Obligations</strong>: We may disclose your information if required by law or to protect our rights, property, or safety, or that of others.</li>
                </ul>
            </p>
            ...
            <p className="mb-4 text-gray-700">
                Thank you for trusting Luxion. We value your privacy and are committed to protecting your personal information.
            </p>
        </div>
        <Footer/>
    </div>
