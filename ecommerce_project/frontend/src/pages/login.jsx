...
function Login() {
    ...
    return (
        <div className="md:py-36 py-20 m-4">
            <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                ...
                <div className="w-full p-8 lg:w-1/2">
                    ...
                    <a href="#" className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md shadow-purple-100 hover:bg-gray-100">
