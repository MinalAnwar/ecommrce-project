    ...
    return (
        <div>
            <div class="flex flex-row items-start mb-5 transform transition-transform hover:-translate-y-2 hover:scale-105 transition-opacity duration-1000">
                <div
                    class="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full group bg-gradient-to-br from-purple-500 to-pink-400 text-white text-xl font-semibold">
