            ...
            <div className="px-6 pt-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-14 lg:px-14">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        <h3 className="text-4xl font-bold tracking-wide uppercase font-monoton ">Luxion</h3>
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex">
                            ...
                            <a href="mailto:Farmtech@lorem.mail" aria-label="Our email" title="Our email" className="text-gray-500">Luxion@gmail.com</a>
                        </div>
                        <div className="flex">
                ...
                <div className="flex flex-col-reverse justify-between pb-10 lg:flex-row">
                    <p className="text-sm text-gray-600">
                        © Copyright 2020 Luxion Inc. All rights reserved.
                    </p>
                ...
                <div>
                    <button
                        ...
                        onClick={goToTop}
                        title="Go To Top"
                        className={`fixed z-50 bottom-10 right-10 p-4 border-0 w-14 h-14 rounded-full shadow-md group bg-gradient-to-br from-purple-500 to-pink-400 ${showButton ? 'visible' : 'invisible'} hover:bg-gradient-to-br hover:from-purple-400 hover:to-pink-400 text-white text-lg font-semibold transition-colors duration-300`}
                    >
