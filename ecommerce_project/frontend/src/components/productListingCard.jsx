...
function ProductCard ({ id, image, brand, name, price, originalPrice }){
  return (
    <div className="lg:w-96 md:w-80 sm:w-64 w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
      <Link to={`/product/${id}`} state={{ image, brand, name, price, originalPrice }}>
        <img
          src={image}
          alt={name}
